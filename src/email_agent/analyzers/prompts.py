...
PERSONA: dict[Profile, str] = {
    ...
    Profile.ONCALL: (
        ...
        "Vendor marketing, release-notes digests, recurring 'all green' status reports and "
        "automated low-severity notifications are low priority. A resolved incident is "
